      ...
      <div className="container max-w-6xl mx-auto relative z-10">
        ...
        <div className="grid md:grid-cols-3 gap-8 text-left">
          {features.map((feature, idx) => (
            <Card
              key={idx}
              className="bg-[#1a1a1a] border-none shadow-xl hover:shadow-2xl transition-all duration-300 hover:-translate-y-2 group overflow-hidden"
            >
              <CardHeader className="flex flex-row items-start gap-4 p-6 pb-2">
                ...
                <CardTitle className="font-bold text-xl pt-1 text-white">{feature.title}</CardTitle>
              </CardHeader>
