      ...
      <div className="container max-w-6xl mx-auto relative z-10">
        <Reveal>
          <div className="text-center mb-12">
            <h2 className="font-display text-3xl font-bold sm:text-4xl mb-4 text-foreground">Your Wallet, <span className="text-primary">Your Privacy</span></h2>
            ...
            <Reveal key={feature.title} delay={idx * 120}>
              <Card className="h-full bg-card card-glow-border shadow-xl hover:-translate-y-2 group overflow-hidden">
                <CardHeader className="flex flex-row items-start gap-4 p-6 pb-2">
                  ...
                  <CardTitle className="font-display font-bold text-xl pt-1 text-foreground">{feature.title}</CardTitle>
                </CardHeader>
