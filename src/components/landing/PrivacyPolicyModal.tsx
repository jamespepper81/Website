      ...
      <DialogContent className="max-w-3xl touch-manipulation">
        ...
        <ScrollArea className="h-[60vh] pr-6">
          <div className="prose prose-invert max-w-none text-muted-foreground font-normal">
            ...
            <h3 className="text-xl font-semibold text-primary">2. What Data We Collect</h3>
            ...
            <h3 className="text-xl font-semibold text-primary">3. How We Use Your Information</h3>
            ...
            <h3 className="text-xl font-semibold text-primary">4. Cookies</h3>
            <p>
            ...
            <h3 className="text-xl font-semibold text-primary">5. Data Storage and Retention</h3>
            <p>
            ...
            <h3 className="text-xl font-semibold text-primary">6. Your Rights</h3>
            <p>
            ...
            <h3 className="text-xl font-semibold text-primary">7. Data Security</h3>
            <p>
            ...
            <h3 className="text-xl font-semibold text-primary">8. Changes to This Policy</h3>
            <p>
            ...
            <h3 className="text-xl font-semibold text-primary">9. Contact Us</h3>
            <p>
