  ...
  return (
    <section className="edge-to-edge-section py-20 md:py-24 lg:py-32 bg-secondary/30 relative overflow-hidden">
      ...
      <div className="container max-w-3xl mx-auto text-center relative z-10">
        <h2 className="text-3xl font-bold mb-6 text-gradient-complementary">About BitSleuth Analyzer</h2>
        ...
        <div className="flex flex-wrap justify-center gap-3 pt-6">
          ...
          <ValueBadge icon={Blocks} text="On-Chain Transparency" variant="complementary" />
          <ValueBadge icon={Shield} text="Privacy Tools" variant="complementary" />
        </div>
      </div>
    </section>
  );
