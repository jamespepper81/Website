    ...
    <section className="edge-to-edge-section py-20 md:py-24 lg:py-32 bg-secondary/20 relative overflow-hidden">
      ...
      <div className="container max-w-4xl mx-auto text-center relative z-10">
        <div className="space-y-6">
          <h2 className="text-3xl md:text-4xl font-bold text-gradient-complementary">About BitSleuth</h2>
          ...
          <div className="pt-4 flex flex-wrap justify-center gap-3 text-sm">
            <ValueBadge icon={Eye} text="Transparency First" variant="complementary" />
            <ValueBadge icon={Shield} text="Privacy Focused" variant="complementary" />
            <ValueBadge icon={Bitcoin} text="Bitcoin Native" variant="complementary" />
          </div>
        </div>
      </div>
    </section>
