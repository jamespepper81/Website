      ...
      <section className="bg-background py-16 md:py-24 relative overflow-hidden">
        ...
        <div className="container max-w-4xl mx-auto px-4 md:px-6 relative z-10">
          ...
          <div className="prose prose-invert max-w-none text-muted-foreground">
            ...
            <h3 className="text-xl font-bold text-primary">5. Data Storage and Retention</h3>
            <p className="font-normal">
            ...
            <h3 className="text-xl font-bold text-primary">7. Data Security</h3>
            <p className="font-normal">
            ...
            <h3 className="text-xl font-bold text-primary">8. Changes to This Policy</h3>
            <p className="font-normal">
            ...
            <h3 className="text-xl font-bold text-primary">9. Contact Us</h3>
            <p className="font-normal">
