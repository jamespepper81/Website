    ...
    <div className="flex flex-col min-h-dvh bg-background">
      ...
      <GlossaryPageWrapper termSlug="rbf" relatedTerms={relatedTerms}>
            ...
            <p itemProp="description" className="text-lg text-muted-foreground font-normal">
              Replace-by-Fee (RBF) is a Bitcoin protocol feature that allows an unconfirmed transaction to be replaced with a new version that pays a higher fee. This gives users flexibility to adjust fees if their transaction gets stuck in the <Link href="/glossary/mempool" className="text-complementary hover:underline">mempool</Link> during periods of network congestion.
            </p>

            <Card className="my-6 bg-secondary/30">
              <CardContent className="p-4">
                 <h3 className="text-xl font-bold flex items-center mb-2">
                    <RefreshCw className="mr-2 h-6 w-6 text-complementary" />
                    How RBF Works
                </h3>
                <p className="text-muted-foreground mt-2 font-normal">
                    To use RBF, a transaction must be marked as replaceable when first created (using BIP 125 signaling). If it doesn't confirm quickly enough, you can broadcast a replacement transaction spending the same <Link href="/glossary/utxo" className="text-complementary hover:underline">UTXOs</Link> but with a higher <Link href="/glossary/fee-rate" className="text-complementary hover:underline">fee rate</Link>.
                </p>
              </CardContent>
            </Card>
            ...
            <h2 className="text-3xl font-bold mt-12 mb-4 text-gradient-complementary">
             ...
             <div className="mt-8 grid md:grid-cols-2 gap-8">
                ...
                <div>
                    ...
                    <p className="text-muted-foreground mt-2 font-normal">
                      RBF transactions should not be accepted for zero-confirmation payments, as they can be replaced before being mined. Merchants should wait for <Link href="/glossary/confirmation" className="text-complementary hover:underline">confirmations</Link> when accepting RBF-enabled transactions.
                    </p>
                </div>
            </div>
            
            <p className="text-muted-foreground mt-8 font-normal">
             Modern <Link href="/glossary/wallet" className="text-complementary hover:underline">wallets</Link> increasingly support RBF by default, as it provides users with more control over transaction confirmation times. An alternative approach is <Link href="/glossary/cpfp" className="text-complementary hover:underline">CPFP (Child Pays for Parent)</Link>, where the recipient can speed up confirmation.
            </p>
          </GlossaryPageWrapper>
