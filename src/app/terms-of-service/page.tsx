      ...
      <main className="flex-1 py-12 md:py-20 lg:py-24 relative overflow-hidden">
        ...
        <div className="container max-w-4xl mx-auto px-4 md:px-6 relative z-10">
          ...
          <div className="prose prose-invert max-w-none text-muted-foreground">
            ...
            <h3 className="text-xl font-bold text-gradient-complementary">3. Acceptable Use</h3>
            <p className="font-normal">
            ...
            <h3 className="text-xl font-bold text-gradient-complementary">5. Privacy</h3>
            <p className="font-normal">
            ...
            <p className="font-normal">
              ...
              <button onClick={openPrivacyModal} className="text-complementary hover:underline underline-offset-4 font-medium p-0 m-0 bg-transparent border-none cursor-pointer">
                Privacy Policy
              </button>
              .
            </p>

            <h3 className="text-xl font-bold text-gradient-complementary">6. No Custody or Exchange Services</h3>
            <p className="font-normal">
            ...
            <h3 className="text-xl font-bold text-gradient-complementary">8. Disclaimers</h3>
            <p className="font-normal">
            ...
            <h3 className="text-xl font-bold text-gradient-complementary">9. Limitation of Liability</h3>
            <p className="font-normal">
            ...
            <h3 className="text-xl font-bold text-gradient-complementary">10. Changes to These Terms</h3>
            <p className="font-normal">
            ...
            <h3 className="text-xl font-bold text-gradient-complementary">11. Contact</h3>
            <p className="font-normal">
